...
try:
    # CSV 파일 생성 및 헤더 작성
    with open('rock2.csv', mode='w', newline='', encoding='utf-8') as file:
            ...
            for item in tracks:
                ...
                if track and track['id']:  # 트랙 정보와 ID가 있는 경우에만 추가
                    track_data.append({
                        ...
                        "title": track['name'],
                        "id": track['id'],
                        "artist_uri": track['artists'][0]['uri']  # 아티스트 URI 추가
                    })
            ...
            for i in range(0, len(track_ids), 100):
                ...
                for j, features in enumerate(audio_features):
                    if features:
                        ...
                        # 아티스트의 장르 정보 요청
                        artist_info = sp.artist(artist_uri)  # 아티스트 URI를 사용하여 정보 요청
